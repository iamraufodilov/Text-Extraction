...
def fit(self, x_lstm_phrase, x_lstm_context, x_dense, y,
            val_split=0.25, patience=5, max_epochs=100, batch_size=32):
...
# CONCLUSION
'''
This is information extraction model
with the help of deep network we extracted information from text
'''